...
public class ChatService {
    ...
    public CompletableFuture<String> getCombinedAnswer(String prompt) {
        ...
        return CompletableFuture.allOf(answer1, answer2, answer3).thenApply(v -> {
            return "Model 1: " + answer1.join() + "\nModel 2: " + answer2.join() + "\nModel 3: " + answer3.join();
        });
    }
}
